...
def seed_shops():
    ...
    shop_two = Shop(
        owner_id=2,
        shop_name="Canvases",
        shop_description="My canvases are designed to make your painting experience flow like the Rubicon.",
        shop_img="https://www.wall26.com//data/product/054/54229/preview/hdVa7W6tnIx6CvCDfL59sIrYR0sfrbWvGcfIbC5X.jpg"
    )
    shop_three = Shop(
        owner_id=3,
        shop_name="Palette Knives",
    ...
    shop_six = Shop(
        owner_id=3,
        shop_name="Roman Palette Knives",
